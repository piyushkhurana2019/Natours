...
var signup = function signup(_x3, _x4, _x5, _x6) {
  return (_ref2 = _ref2 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(name, email, password, passwordConfirm) {
    var res;
...
var bookTour = function bookTour(_x) {
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51NrdQXSCadBcM6pEp1OZeSUqu2x0JiDN179jYCH5k7gOKPWPJW8u5tZJ8XFuEPBn20XChbJ5wHayNrW8u6DJmF6i004jArzIUl');
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)("http://localhost:9000/api/v1/bookings/checkout-session/".concat(tourId));
        case 4:
