...
reviewSchema.statics.calcAverageRating = async function (tourId) {
  const stats = await this.aggregate([
    //statics method gives us the acces to use this but instance method doensn't
    {
      $match: { tour: tourId },
    },
    {
...
reviewSchema.post('save', function () {
  //post bcz tb tk saare review store ho chuke honge pre m nhi hua hoga current vala reh jayega and post middleware doesnt get access to next
